        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 z-50 flex h-full w-full max-w-sm flex-col border-l"
              style={{
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  <Trash2 size={14} style={{ color: "var(--text-muted)", opacity: 0.6 }} />
                  <span
                ...
                <button
                  ...
                  className="flex h-7 w-7 items-center justify-center transition-colors hover:text-text-primary"
                  style={{ borderRadius: "6px", color: "var(--text-muted)" }}
                >
                  <X size={14} />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4">
                {deletedFrames.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    <Trash2 size={24} style={{ color: "var(--text-muted)", opacity: 0.15, marginBottom: 12 }} />
                    <p className="text-xs tracking-wider" style={{ color: "var(--text-muted)", opacity: 0.35 }}>
                      回收站是空的
                    </p>
                    <p className="mt-1 text-[10px]" style={{ color: "var(--text-muted)", opacity: 0.2 }}>
                      删除的帧会在这里保留 7 天
                    </p>
                  </div>
                ) : (
                      ...
                      .map((frame) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="mb-2 flex items-center gap-2 text-[9px]" style={{ color: "var(--text-muted)", opacity: 0.35 }}>
                            ...
                            {confirmId === frame.id ? (
                              <div
                                ...
                                style={{ borderColor: "var(--status-error)", background: "var(--bg-soft)", opacity: 0.6 }}
                              >
                                <div className="flex items-center gap-1.5 text-[10px]" style={{ color: "var(--status-error)", opacity: 0.7 }}>
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className="flex flex-1 items-center justify-center gap-1 rounded py-1.5 text-[10px] transition-colors hover:opacity-80"
                                  style={{
                                    border: "1px solid var(--border-soft)",
                                ...
                                <button
                                  ...
                                  className="flex flex-1 items-center justify-center gap-1 rounded py-1.5 text-[10px] transition-colors"
                                  style={{
                                    border: "1px solid var(--border-soft)",
                                    color: "var(--text-muted)",
                                    opacity: 0.5,
              ...
              {deletedFrames.length > 0 && (
                <div
                  className="border-t px-5 py-3 text-center text-[9px]"
                  style={{
                    borderColor: "var(--border-soft)",
                    color: "var(--text-muted)",
                    opacity: 0.25,
